...
const loadPartsList = __webpack_require__(38);
const loadButtons = __webpack_require__(40);
const sortFilter = __webpack_require__(46);
const psExpander = __webpack_require__(184);
...
module.exports = {
    loadCollapsed(btnID) {
        ...
        if (loadedPrior == 0) {
            Promise.resolve($(__webpack_require__(45))) // place collapsed HTML inside variable
                .then((collapsedHTML) => {
                ...
                .then(() => {
                    var modReqQteHtml = __webpack_require__(180);
...
/* WEBPACK VAR INJECTION */(function($) {module.exports = (ev, fType) => {

    const fp = __webpack_require__(16); // fp.byMake return the filteredPartsData data object
    console.log(fType);
    var loadPartsIntoContainer = (filteredPartsData) => {
        for (var key in filteredPartsData) {
            var partHtml = __webpack_require__(39);
            var partID = key;
...
module.exports = "<div class=\"card partsListingD\"> <div class=card-header id=headingOne> <h5 class=mb-0> <button class=\"btn btn-light container-fluid partListing\" data-toggle=collapse data-target=#collapseOne aria-expanded=true aria-controls=collapseOne> <div class=row> <div class=\"pName col-sm-6 text-left\"> Sec1 </div> <div class=\"pNum col-sm-2 text-right\"> Sec1 </div> <div class=\"pRandPrice col-sm-2 text-right\"> Sec2 </div> <div class=\"pDollarPrice col-sm-2 text-right\"> Sec3 </div> </div> </button> </h5> </div> <div id=collapseOne class=collapse aria-labelledby=headingOne data-parent=#accordion> <div class=\"card-body container-fluid\"> <div class=se-pre-con-1></div> </div> </div> </div>";
...
module.exports = function(event, fType) {
    $('#left').append(__webpack_require__(181));
    $('.defFilter').html('<div class="p2">Apply Filter</div><div class="filterIcon ml-auto p-2 fa fa-filter"></div>');
    const fp = __webpack_require__(16);
    const badges = __webpack_require__(6);
...
module.exports = {"BMW":"BMW","LANDROVER":"Land Rover","KTM":"KTM","HONDA":"Honda","YAMAHA":"Yamaha","TRIUMPH":"Triumph","TWINAFRICA":"Twin Africa"}
...
//Import badges
var bmwBadge = __webpack_require__(9);
var landRoverBadge = __webpack_require__(10);
var ktmBadge = __webpack_require__(11);
var hondaBadge = __webpack_require__(12);
var yamahaBadge = __webpack_require__(13);
var triumphBadge = __webpack_require__(14);
var twinAfricaBadge = __webpack_require__(15);
