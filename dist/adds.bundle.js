...
const loadPartsListD = __webpack_require__(31);
const loadButtonsD = __webpack_require__(33);
const sortFilter = __webpack_require__(40);
const psExpander = __webpack_require__(37);
...
//Import badges
var bmwBadge = __webpack_require__(7);
var landRoverBadge = __webpack_require__(8);
var ktmBadge = __webpack_require__(9);
var hondaBadge = __webpack_require__(10);
var yamahaBadge = __webpack_require__(11);
var triumphBadge = __webpack_require__(12);
var twinAfricaBadge = __webpack_require__(13);
...
module.exports = (ev, fType) => {
    ...
    const fp = __webpack_require__(4); // fp.byMake return the filteredPartsData data object
    console.log(fType);
    var loadPartsIntoContainer = (filteredPartsData) => {
        for (var key in filteredPartsData) {
            var partHtml = __webpack_require__(32);
            var partID = key;
...
/* WEBPACK VAR INJECTION */(function($) {  /*--------------------------------------*/
  ...
  module.exports = function(event, fType) {
      $('#left').append(__webpack_require__(34));
      ...
      const badges = __webpack_require__(3);
...
module.exports = {
    loadCollapsed(btnID) {
        ...
        if (loadedPrior == 0) {
            Promise.resolve($(__webpack_require__(38))) // place collapsed HTML inside variable
                .then((collapsedHTML) => {
                ...
                .then(() => {
                    var modReqQteHtml = __webpack_require__(39);
